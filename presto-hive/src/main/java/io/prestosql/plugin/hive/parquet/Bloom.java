...
public class Bloom
{
    ...
    public Bloom(HdfsEnvironment hdfsEnvironment, Path dataPath, String user, Configuration conf)
    {
        try {
            FileSystem fileSystem = hdfsEnvironment.getFileSystem(user, dataPath, conf);
