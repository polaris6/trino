...
public interface DynamicCatalogManager
{
    void addCatalogConfigurationManagerFactory(CatalogConfigurationManagerFactory factory);

    void loadConfigurationManager()
            throws Exception;

    CatalogConfigurationManager getCatalogConfigurationManager();
