...
import static io.prestosql.sql.ExpressionTestUtils.analyzeExpression;
...
public class TestDataTypeImplicitConvert
{
    ...
    {
        Expression exp1 = expression("DOUBLE '1.12' ='1'");
        analyzeExpression(metadata, exp1);
        assertExpressionEquals(expression(exp1.toString()), expression("(DOUBLE '1.12' = TRY(CAST('1' AS double)))"));

        Expression exp2 = expression("DOUBLE '1.12'!='1'");
        analyzeExpression(metadata, exp2);
        assertExpressionEquals(expression(exp2.toString()), expression("(DOUBLE '1.12' <> TRY(CAST('1' AS double)))"));

        Expression exp3 = expression("DOUBLE '1.12'>'1'");
        analyzeExpression(metadata, exp3);
        assertExpressionEquals(expression(exp3.toString()), expression("(DOUBLE '1.12' > TRY(CAST('1' AS double)))"));

        Expression exp4 = expression("DOUBLE '1.12'>='1'");
        analyzeExpression(metadata, exp4);
        assertExpressionEquals(expression(exp4.toString()), expression("(DOUBLE '1.12' >= TRY(CAST('1' AS double)))"));

        Expression exp5 = expression("DOUBLE '1.12'<'1'");
        analyzeExpression(metadata, exp5);
        assertExpressionEquals(expression(exp5.toString()), expression("(DOUBLE '1.12' < TRY(CAST('1' AS double)))"));

        Expression exp6 = expression("DOUBLE '1.12'<='1'");
        analyzeExpression(metadata, exp6);
        assertExpressionEquals(expression(exp6.toString()), expression("(DOUBLE '1.12' <= TRY(CAST('1' AS double)))"));
    }
    ...
    {
        Expression exp1 = expression("DOUBLE '1.12' in('1','2','3')");
        analyzeExpression(metadata, exp1);
        assertExpressionEquals(expression(exp1.toString()), expression("(DOUBLE '1.12' IN (TRY(CAST('1' AS double)), TRY(CAST('2' AS double)), TRY(CAST('3' AS double))))"));

        Expression exp2 = expression("'1.12' in(DOUBLE '1.1',DOUBLE '1.2',DOUBLE '1.3')");
        analyzeExpression(metadata, exp2);
        assertExpressionEquals(expression(exp2.toString()), expression("('1.12' IN (TRY(CAST(DOUBLE '1.1' AS varchar)), TRY(CAST(DOUBLE '1.2' AS varchar)), TRY(CAST(DOUBLE '1.3' AS varchar))))"));

        Expression exp3 = expression("DOUBLE '1.1' in(DOUBLE '1.1','2',DOUBLE '1.2')");
        analyzeExpression(metadata, exp3);
        assertExpressionEquals(expression(exp3.toString()), expression("(DOUBLE '1.1' IN (DOUBLE '1.1', TRY(CAST('2' AS double)), DOUBLE '1.2'))"));
    }
    ...
    {
        Expression exp1 = expression("DOUBLE '1.12' between '1' and '2'");
        analyzeExpression(metadata, exp1);
        assertExpressionEquals(expression(exp1.toString()), expression("(DOUBLE '1.12' BETWEEN TRY(CAST('1' AS double)) AND TRY(CAST('2' AS double)))"));
        ...
        Expression exp3 = expression("DOUBLE '1.12' between '1' and DOUBLE '1.13'");
        analyzeExpression(metadata, exp3);
        assertExpressionEquals(expression(exp3.toString()), expression("(DOUBLE '1.12' BETWEEN TRY(CAST('1' AS double)) AND DOUBLE '1.13')"));
    }
}
