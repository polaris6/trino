...
public class NoOpCatalogConfigurationManagerFactory
        implements CatalogConfigurationManagerFactory
{
    ...
    {
        try {
            Bootstrap app = new Bootstrap(new NoOpCatalogModule());
            ...
            Injector injector = app
                    ...
                    .initialize();
            return injector.getInstance(NoOpCatalogConfigurationManager.class);
        }
        catch (Exception e) {
            throwIfUnchecked(e);
